...
/**
 * Case Assignment Timeline Component
 *
 ...
 */
function CaseAssignmentTimeline({ assignmentData, case: caseData, onAssign }) {
  ...
  const calculateAssignmentDuration = (assignment, nextAssignment) => {
    ...
    const end = new Date(nextAssignment.createdAt);
                  ...
                  <AssignmentInfo>
                    <UserInfo>
                      ...
                      <UserDetails>
                        ...
                        <Text size="xs" color="muted">
                          {getUserRole(assignment.assignedTo) ||
                            "No role specified"}
                        </Text>
                        {!isMobile && assignment.assignedTo?.email && (
                          <Text
                            size="xs"
                            color="muted"
                            style={{
                    ...
                    <MetaInfo>
                      ...
                      {assignment.assignedBy && (
                        <MetaRow>
                          <HiOutlineUser />
                          <span>
                            by {getUserDisplayName(assignment.assignedBy)}
                          </span>
                        </MetaRow>
                      )}
                    </MetaInfo>
                      ...
                      {assignment.comments && (
                        <CommentsBubble>
                          ...
                          >
                            ...
                            <Text size="xs" weight="medium" color="brand">
                              Assignment Comments
                            </Text>
                          </div>
                          <Text size="sm">{assignment.comments}</Text>
                        </CommentsBubble>
                      )}
                      ...
                      {isCurrent && (
                        ...
                        >
                          <Text size="xs" weight="medium" color="success">
                            ✓ This is the current active assignment
                          </Text>
                        </div>
                      )}
                    </ExpandedContent>
...
CaseAssignmentTimeline.propTypes = {
...
export default CaseAssignmentTimeline;
