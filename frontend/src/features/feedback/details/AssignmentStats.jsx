 ...
 */
function AssignmentStats({ assignmentData, feedback }) {
  if (!assignmentData) {
    return (
      <StatsContainer>
        <StatCard>
  ...
  const totalDurationMs =
    firstAssignment && lastAssignment
      ? new Date(lastAssignment.updatedAt) - new Date(firstAssignment.updatedAt)
      : 0;
  ...
  return (
    <StatsContainer>
          ...
          <AssigneeInfo>
            <div>
              ...
              <Text size="sm" color="muted">
                {currentAssignee.role || "No role specified"}
              </Text>
              <Text size="xs" color="muted">
                Assigned {formatRelativeTime(lastAssignment?.updatedAt)}
              </Text>
            </div>
          </AssigneeInfo>
        </CurrentAssigneeCard>
      ...
      <StatCard>
        ...
        <DetailsList>
          ...
          <DetailItem>
            ...
            <Text size="sm" weight="medium">
              {firstAssignment
                ? formatRelativeTime(firstAssignment.updatedAt)
                : "Never"}
            </Text>
          </DetailItem>
          <DetailItem>
            ...
            <Text size="sm" weight="medium">
              {lastAssignment
                ? formatRelativeTime(lastAssignment.updatedAt)
                : "Never"}
            </Text>
          </DetailItem>
        </DetailsList>
      ...
      <StatCard>
        ...
        <StatContent>
          <StatValue>{feedback.status?.toUpperCase()}</StatValue>
          <Text size="sm" color="muted">
            Priority: {feedback.priority} • Category:{" "}
