...
// Import hooks
import { useFeedbackAssignmentHistory } from "./../useFeedbackAssignmentHistory";
...
/**
 * FeedbackAssignment Component
 *
 * Displays comprehensive assignment information for a feedback case
 * including timeline, statistics, and management capabilities
 */
function FeedbackAssignment({ feedback, feedbackId, onRefresh, onAssign }) {
  const [activeSubTab, setActiveSubTab] = useState("timeline");

  // Fetch assignment history data using existing feedback history endpoint
  const {
    data: assignmentHistory,
    isLoading: isLoadingHistory,
    error: historyError,
    refetch: refetchHistory,
  } = useFeedbackAssignmentHistory(feedbackId);
  ...
  return (
    <TabContainer>
      ...
      <ContentGrid>
        ...
        {/* Side Panel - Only Assignment Statistics */}
        <SidePanel>
          <AssignmentStats
            assignmentData={assignmentData}
            feedback={feedback}
